...
const stageGradients: Record<string, { from: string; to: string; blur: number }> = {
  ...
  organ:    { from: "rgba(255,248,245,0.88)", to: "rgba(252,242,238,0.85)", blur: 0 },
  gut:      { from: "rgba(245,255,248,0.88)", to: "rgba(240,252,242,0.85)", blur: 0 },
  omega:    { from: "rgba(245,248,255,0.88)", to: "rgba(238,244,255,0.85)", blur: 0 },
