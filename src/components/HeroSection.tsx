        ...
        {tins.map((tin) => (
          <div key={tin.alt} className="flex flex-col items-center gap-3 min-w-0 flex-1 basis-0 md:flex-initial md:basis-auto">
            <img
              src={tin.src}
              alt={tin.alt}
              className="h-auto object-contain mx-auto w-full max-w-[79px] md:max-w-[225px] lg:max-w-[282px]"
                ...
                {tins.map((tin, i) => (
                  <div key={tin.alt} className="flex flex-col items-center gap-4">
                    <img
                      src={tin.src}
                      alt={tin.alt}
                      className="w-full max-w-[150px] lg:max-w-[225px] xl:max-w-[282px] h-auto object-contain"
                      style={{
                        filter:
