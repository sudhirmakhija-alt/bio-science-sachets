...
export const blogPosts: BlogPost[] = [
  {
    ...
    pageTitle: "Green-Lipped Mussel for Dogs — BioLogica Pets",
    metaDescription:
      "Learn why Green-Lipped Mussel is the most effective marine omega supplement for dogs — better than fish oil for joints, coat, and heart health.",
  ...
  {
    slug: "leaky-gut-dogs",
    pageTitle: "Signs Your Dog Has Leaky Gut — and What to Do | BioLogica Pets",
    metaDescription:
      "Loose stools, itchy skin, low energy and recurring ear infections can all point to the same root cause — your dog's gut health.",
  ...
  },
  {
    ...
    pageTitle: "Why Organ Meat Is the Most Nutrient-Dense Food for Dogs | BioLogica Pets",
    metaDescription:
      "Wolves eat organs first for a reason. Here's why organ meat contains 10–100x the nutrients of muscle meat, and why modern dogs are missing it.",
    heroImage: "https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=1200&q=80",
    category: "Immunity",
